  ...
  <div class="home_page vls">
    <div class="w1380 CloudBox flexRowAC">
      <div class="CloudL">
        ...
        <div class="cl_d">
          共享与协作，支持图片、音视频、日志等海量文件 快速存储及下载
        </div>
        <div class="flexRowAC useBox">
          <div class="seeMore">
            立即试用
          </div>
          <div class="seeMore red">
            立即购买
          </div>
    ...
    <div class="w1380 webBottomImg">
      <video class="wBImg" src="/documents/云盘.mp4" controls autoplay muted />
    </div>
    <!--闪传-->
    <div class="productBox w1380">
      <div class="card_container car flexRowAC">
        <div class="card_2 flexRowAC">
          <div class="card_2_l">
            <div class="card_2_t1">
              闪传
            </div>
            智能秒传，快到无感 <br />无限制分享超大文件
          </div>
          <div class="card_2_r flexRowAC">
            <div class="flexRowAC card_file">
              <img class="card_2_t_img" src="@/assets/problemFeedback/cloudAlbum_sc1.png" alt="" />
              智能秒传
            </div>
            <div class="flexRowAC card_file">
              <img class="card_2_t_img" src="@/assets/problemFeedback/cloudAlbum_sc2.png" alt="" />
              超大文件分享
            </div>
          </div>
        </div>
        <div class="card_2 flexRowAC">
          ...
          <div class="card_2_r flexRowAC">
            <div class="flexRowAC card_file">
              <img class="card_2_t_img" src="@/assets/problemFeedback/cloudAlbum_sc3.png" alt="" />
              不限速
            </div>
            <div class="flexRowAC card_file">
              <img class="card_2_t_img" src="@/assets/problemFeedback/cloudAlbum_sc4.png" alt="" />
              专属通道
            </div>
            <div class="flexRowAC card_file">
              <img class="card_2_t_img" src="@/assets/problemFeedback/cloudAlbum_sc5.png" alt="" />
              智能提速
            </div>
          </div>
        </div>
      ...
      <div class="card_container flexRowAC">
        <div class="card_1">
          <img class="card_1_img" src="@/assets/problemFeedback/cloudAlbum_i3.png" alt="" />
          <p>支持查看云端，本地，跨网文件、图片、音视频、日志等海量文件快速存储</p>
        </div>
        <div class="card_1">
          <img class="card_1_img" src="@/assets/problemFeedback/cloudAlbum_i3.png" alt="" />
          <p>简单易用 、便于管理、集成数据处理</p>
        </div>
        <div class="card_1">
          <img class="card_1_img" src="@/assets/problemFeedback/cloudAlbum_i3.png" alt="" />
          <p>拥有多重访问控制及权限管理分配</p>
